...
public class StrategyRepository implements IStrategyRepository {
    ...
    @Override
    public void saveRedis(Long strategyId, BigDecimal rateRange, HashMap<Integer, Integer> shuffleAwardRateTable) {
    ...
    @Override
    public Integer getStrategyAwardAssemble(Long strategyId, int awardId) {
